...
IF OBJECT_ID ( 'dbo.sp_CheckDuplicateEntityType', 'P' ) IS NOT NULL
BEGIN
   DROP PROCEDURE dbo.sp_CheckDuplicateEntityType;
END;
GO
...
--
--
-- Example: EXEC dbo.sp_CheckDuplicateEntityType
-- ====================================================================================================

CREATE PROCEDURE dbo.sp_CheckDuplicateEntityType
