    ...
    public class RoleController : BaseController
    {
        ...
        public virtual ActionResult Index()
        {
            ManageRolesViewModel model = new ManageRolesViewModel
                                             {
                                                 Roles = new SelectList(roleService.GetAllRoles()),
        ...
        {
            JsonResponse response = new JsonResponse { Messages = new List<ResponseItem>()};
            ...
            foreach (var role in roleNames.Where(role => !string.IsNullOrEmpty(role)))
            {
                ResponseItem item;
                try
                {
        ...
        public ActionResult GetAllRoles()
        {
            ...
            List<SelectObject> selectList = list.Select(item => new SelectObject { caption = item, value = item}).ToList();
